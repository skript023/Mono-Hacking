...
MONO_API MONO_RT_EXTERNAL_ONLY MonoClass** mono_metadata_interfaces_from_typedef(MonoImage* meta, uint32_t table_index, unsigned int* count);
...
MONO_API MONO_RT_EXTERNAL_ONLY MonoType* mono_metadata_parse_type(MonoImage* m,
    ...
    const char* ptr,
    const char** rptr);
MONO_API MONO_RT_EXTERNAL_ONLY MonoType* mono_metadata_parse_param(MonoImage* m,
    const char* ptr,
    const char** rptr);
MONO_API MONO_RT_EXTERNAL_ONLY MonoType* mono_metadata_parse_field_type(MonoImage* m,
    ...
    const char* ptr,
    const char** rptr);
MONO_API MONO_RT_EXTERNAL_ONLY MonoType* mono_type_create_from_typespec(MonoImage* image,
    uint32_t type_spec);
...
MONO_API MONO_RT_EXTERNAL_ONLY MonoMethodSignature* mono_metadata_parse_signature(MonoImage* image,
    uint32_t token);
